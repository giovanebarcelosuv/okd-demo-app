...
Este é um repositório de aplicativos de turno aberto de amostra que pode ser implementado via `oc new-app`

Hello World via nginx sobre o Alpine Linux
...
<html lang="en">
    ...
    <body>
        <div class="page-header" align=center>
          <h1>Bem Vindo ao OKD v3 Demo App</h1>
        </div>
